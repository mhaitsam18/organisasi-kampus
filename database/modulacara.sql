...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2021 at 04:37 PM
...
INSERT INTO `acara` (`id`, `id_pengurus`, `nama_acara`, `penyelenggara`, `tanggal_dimulai`, `waktu_dimulai`, `tanggal_berakhir`, `waktu_berakhir`, `poster`, `keterangan`, `tanggal_dibuat`) VALUES
(4, 0, 'UKM Fair', 'TelU', '2021-06-16', '00:00:00', '2021-06-16', '00:00:00', 'default.jpg', 'Pameran UKM', '0000-00-00 00:00:00'),
(5, 0, 'Pameran Perhotelan', 'HMPH', '2021-04-16', '00:00:00', '2021-06-16', '00:00:00', 'default.jpg', 'Pameran beserta bazar', '0000-00-00 00:00:00'),
...
(34, 3, 1, 'halo', '2021-07-28 23:49:14', 1, 0),
...
(1, 1, 'Bismillah', 'BI', 'Organisasi yang menghimpun Organisasi di Telkom University, sekaligus admin dari Aplikasi ini', '1200px-Telkom_University_Logo_svg.png', 1, 1),
...
(1, 'Alya Putri Maharani', 'alya.pmaharani@gmail.com', 'Perempuan', 'Bandung', '2000-06-25', '089631424631', 'Jl. Sukapura, No. 36, Desa Sukapura, Kec. Dayeuhkolot, Kab. Bandung, Jawa Barat', 1, 'alya.jpeg', '$2y$10$yFaxQ6OR.n8SLvWDdUS6iuq4ukoCz.WGHu6QnjyTnv6vBn3Xc0nbe', 0, 1, 1609656473),
(2, 'Olga Paurenta Simanihuruk', 'olgapaurenta11@gmail.com', 'Perempuan', 'Medan', '2000-11-26', '082169006807', 'Jl Jahe 13 No 3 Simalingkar, Kelurahan Mangga, Kecamatan Medan Tuntungan, Kota Medan  Kode Pos 20141', 2, 'default.jpg', '$2y$10$DLCp6ce7jyHem7q/eNcPbOeYeuU8dp3kwtgZ5lz3aVsDaIJsgjPHu', 2, 1, 1609657135),
(3, 'Akib Dahlan', 'akibdahlan20@gmail.com', 'Laki-laki', 'Palembang', '2000-02-20', '082289412433', 'PGA', 1, 'default.svg', '$2y$10$HVFG5RnAq4MpTWNV6jm0EuPiVy0gfpJmQSuT5WE03uzGIdeMZItV.', 3, 1, 1623729434),
(25, 'Rini Sarlita', 'riniastkepsarlita@gmail.com', 'Perempuan', 'Duri', '2002-03-25', '0812123123123', 'Jl. Mandau', 1, 'default.svg', '$2y$10$EZU1tpb4VnU8/gaWUnzd2.gIqrNgAlX7bJ7ELMgAdznKQ0Konjbd.', 2, 1, 1626594066),
(26, 'Firman Aldo Saputra', 'fasaldo1998@gmail.com', 'Laki-laki', 'Padang', '1999-09-01', '082102192012', 'Jl. Pariaman', 1, 'default.svg', '$2y$10$HC4FagiE4PTD7TA.lEqca.4X7SFcQnXcb/4HA95RYrqFr3QniCbC6', 3, 1, 1626604588);
...
ALTER TABLE `organisasi`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id_pengurus` (`id_pengurus`);
