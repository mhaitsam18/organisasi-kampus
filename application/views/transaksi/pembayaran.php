				...
				<tbody>
					...
					<?php foreach ($bukti_transfer as $row): ?>
						<tr>
							...
							<td>
								<a href="<?= base_url('assets/img/bukti-pembayaran/').$row['bukti_pembayaran'] ?>" title="<?= $row['bukti_pembayaran'] ?>">
									<img src="<?= base_url('assets/img/bukti-pembayaran/').$row['bukti_pembayaran'] ?>" class="img-thumbnail" style="width: 120px;">
								</a>
							</td>
							<td><?= $row['catatan'] ?></td>
							<td><?= $row['sbt'] ?></td>
